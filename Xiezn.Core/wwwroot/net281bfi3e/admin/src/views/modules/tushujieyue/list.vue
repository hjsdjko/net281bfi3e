				...
				@selection-change="selectionChangeHandler">
					...
					<el-table-column width="300" label="操作">
						<template slot-scope="scope">
							...
							<el-button class="btn8" v-if="isAuth('tushujieyue','归还')" @click="tushuguihaiCrossAddOrUpdateHandler(scope.row,'cross','','','[1]','已归还')" type="success">
								<span class="icon iconfont icon-xihuan" :style='{"margin":"0 2px","fontSize":"inherit","color":"inherit","display":"none","height":"40px"}'></span>
								归还
							</el-button>
							<el-button class="btn8" v-if="isAuth('tushujieyue','续借')" @click="tushuxujieCrossAddOrUpdateHandler(scope.row,'cross','','','','')" type="success">
								<span class="icon iconfont icon-xihuan" :style='{"margin":"0 2px","fontSize":"inherit","color":"inherit","display":"none","height":"40px"}'></span>
								续借
							</el-button>
