				...
				@selection-change="selectionChangeHandler">
					...
					<el-table-column width="300" label="操作">
						<template slot-scope="scope">
							...
							<el-button class="btn8" v-if="isAuth('tushuxinxi','借阅')" @click="tushujieyueCrossAddOrUpdateHandler(scope.row,'cross','','','','')" type="success">
...
import tushujieyueCrossAddOrUpdate from "../tushujieyue/add-or-update";
	export default {
		...
		methods: {
			...
			tushujieyueCrossAddOrUpdateHandler(row,type,crossOptAudit,crossOptPay,statusColumnName,tips,statusColumnValue){
				this.showFlag = false;
